  ...
  <div class="table">
    ...
    <div class="container">
      ...
      >
        ...
        <el-table-column prop="EquipmentName" label="路政设备名称" align="center"></el-table-column>
        ...
        <el-table-column prop="UseCompany" label="使用单位" align="center"></el-table-column>
  ...
  methods: {
    ...
    getData() {
      let param = {
        ...
        type: this.Type,//搜索类型
        UseCompany: this.UseCompany,//使用单位
        page: this.cur_page,//当前页数
        model:0,
      };
      this.$axios.get(this.baseUrl + 'RoadEquipment.asmx/GetEquipmentList', { params: param }).then(res => {
        if (res.data != 0) {
